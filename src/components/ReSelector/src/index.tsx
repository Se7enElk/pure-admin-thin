...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const setCurrentValue = index => {
                ...
                if (index > firstIndex) {
                    ...
                    toggleClass(
                        ...
                        document.querySelector(
                            ".hs-select__item" + selectedList[0].index
                        )
                    );
            ...
            addClass(
                document.querySelector("." + voidClass + index),
                activeClass
            );
        };
        ...
        const resetCurrentValue = index => {
            ...
            const currentHsDom = document.querySelector(
                "." + voidClass + index
            );
                            ...
                            {props.max.map((item, key) => {
                                return (
                                    <td
                                        ...
                                        onMouseleave={() =>
                                            resetCurrentValue(key)
                                        }
                                        onClick={() => selectValue(key, item)}
                                        style={{
                                            cursor: unref(rateDisabled)
                                                ? "auto"
                                                : "pointer",
                                            textAlign: "center"
                                        }}
